...
lib.seq = "\"c('SL.glm','SL.bayesglm', 'SL.gam','SL.earth','SL.ranger','SL.svm','SL.xgboost','SL.mean')\"" # superlearner lib for sequential regression
...
lib.Y = "\"c('SL.glm','SL.bayesglm', 'SL.gam','SL.earth','SL.ranger','SL.svm','SL.xgboost','SL.mean')\"" # superlearner lib for Y
lib.A = "\"c('SL.glm','SL.bayesglm', 'SL.gam','SL.earth','SL.ranger','SL.svm','SL.xgboost','SL.mean')\"" # superlearner lib for A
