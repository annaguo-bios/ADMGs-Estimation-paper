setwd("/Users/apple/Library/CloudStorage/Dropbox/primal-fixability/code/Simulations/sim4-crossfitting-HD/YinL/sparse_forest")
# sample size
n= c(500,1000,2000)
...
table1
quick_latex(table1, file="table-in-sparse.tex")
y
