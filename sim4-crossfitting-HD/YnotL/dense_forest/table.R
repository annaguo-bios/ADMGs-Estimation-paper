setwd("/Users/apple/Library/CloudStorage/Dropbox/primal-fixability/code/Simulations/sim4-crossfitting-HD/YnotL/dense_forest")
# sample size
n= c(500,1000,2000)
...
dat <- list(TMLE.dnorm.RF,TMLE.dnorm.CF, 
            TMLE.densratio.RF, TMLE.densratio.CF,
            TMLE.bayes.RF, TMLE.bayes.CF,
            Onestep.dnorm.RF, Onestep.dnorm.CF,
            Onestep.densratio.RF, Onestep.densratio.CF,
            Onestep.bayes.RF, Onestep.bayes.CF)
...
table1
quick_latex(table1, file="table-not-dense.tex")
